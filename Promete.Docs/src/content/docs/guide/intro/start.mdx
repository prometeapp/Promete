...
## サンプルコード
[Promete.Example](https://github.com/prometeapp/Promete/tree/master/Promete.Example)プロジェクトには、様々な機能を示すサンプルコードが含まれています。
...
**実行時にクラッシュする場合**
- .NET 10 SDKが正しくインストールされていることを確認
- プロジェクトのターゲットフレームワークが`net10.0`に設定されていることを確認
