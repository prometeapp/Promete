...
namespace Promete
{
	public static class DF
	{
		...
		/// <summary>
		/// Open and run Promete Window with the specified Scene.
		/// </summary>
		...
		static DF()
		{
			ctx = new PrSynchronizationContext();
		...
		private static readonly PrSynchronizationContext ctx;
