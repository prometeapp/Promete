...
public class Graphic : ElementBase
{
	...
	public Graphic Triangle(VectorInt v1, VectorInt v2, VectorInt v3, Color color, int lineWidth = 0,
	...
	public Graphic Triangle(int x1, int y1, int x2, int y2, int x3, int y3, Color color, int lineWidth = 0,
		Color? lineColor = null)
